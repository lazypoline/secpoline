...
#include <err.h>
#include <link.h>
<<<<<<< HEAD:secpoline_loader/loader/call_secpoline.c
#include "loader_secpoline.h"
=======
#include "load_secpoline.h"
>>>>>>> lazypoline-secure:src/secpoline_loader/loader/call_secpoline.c
...
<<<<<<< HEAD:secpoline_loader/loader/call_secpoline.c
    ...
    char* secpoline_path;
    char* secpoline_laoder_path;     
    if(!__is_loader){
        secpoline_path = argv[1];
        secpoline_laoder_path = argv[0];        
    }else{
...
<<<<<<< HEAD:secpoline_loader/loader/call_secpoline.c
        secpoline_laoder_path = interp_ent->p_vaddr + application_base;
=======
...
<<<<<<< HEAD:secpoline_loader/loader/call_secpoline.c
    new_sp[2] = (size_t)secpoline_path; //secpoline name
    new_sp[3] = (size_t)rip_after_setup;
    new_sp[4] = rdfsbase();
    new_sp[5] = (size_t)loader_mappings;
    new_sp[6] = (size_t)secpoline_laoder_path;//secpoline loader name
=======
