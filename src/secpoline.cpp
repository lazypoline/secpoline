...
int main(int argc, char* argv[]) {
    ...
    main_constructor();
    fprintf(stderr, "Proxysql initialised]\n");
...
void initialise_syscall_handlers(){
    ...
    //proxysql
    ADD_MAIN_HANDLER(syscall_handler_table, read, recv_package_proxysql);
    ADD_MAIN_HANDLER(syscall_handler_table, recvfrom, recv_package_proxysql);
    ADD_MAIN_HANDLER(syscall_handler_table, write, send_package_proxysql);
    ADD_MAIN_HANDLER(syscall_handler_table, sendto, send_package_proxysql);
    ADD_MAIN_HANDLER(syscall_handler_table, connect, connect_proxysql);
    ADD_PREHANDLER(syscall_handler_table, close, pre_close_proxysql);
